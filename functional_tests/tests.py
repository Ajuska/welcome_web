...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # When she hits enter, t she is taken to a new URL,
        ...
        # Francis starts a new list vy entering a new item. He is les interesting
        # than Edith...
        inputbox = self.browser.find_element_by_id('id_new_item')
    ...
    def test_layout_and_styling(self):
        ...
        # She notices the inpit box nicely centered
        inputbox = self.browser.find_element_by_id('id_new_item')
        ...
        # She starts a new list and sees the inpit is nicelz centered there too
